  ...
  'data': [
    {
      ...
      'type': 'addresses',
      'links': {
        'self': '/reference/v1/addresses/338.json_api'
      },
      'attributes': {
        'meta_attributes': {
          'phone_number': {
      ...
      'relationships': {
        'customer_account': {
          'links': {
            'self': '/reference/v1/addresses/338/relationships/customer_account.json_api',
            'related': '/reference/v1/addresses/338/customer_account.json_api'
          }
        }
      }
    }
